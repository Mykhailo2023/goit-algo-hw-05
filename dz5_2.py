...
def generator_numbers(text: str):
    ...
    if text is not None and text != '':
        ...
        # pattern = r"(?<!\S)[-+]?(?:\d+\.\d+)(?!\S)" # тут є можливість ловити -+ перед цифрами
        pattern = r"(?<!\S)\d+\.\d+(?!\S)"
...
text = "Загальний дохід працівника складається з or4.04 декількох частин: 1000.01 як основний дохід, доповнений додатковими надходженнями 27.45 і 324.00 доларів."
